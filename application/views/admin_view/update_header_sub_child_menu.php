					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Update Sub Child Menu</h3>
							</div>
							<div class="module-body">

									

									<form class="form-horizontal row-fluid" method="POST" action="<?php echo base_url();?>admin/update_sub_child_header_menu">

									<?php foreach ($child_menu_data as $key) {?>
									<input type="hidden" name="child_menu" value="<?php echo $key->child_menu_id;?>">
										...
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" data-placeholder="Select Here....." class="span8" name="header_manu_id" id="header_main_menu" required>
													<option value="">Select Here.....</option>
													<?php foreach ($headre_main_menu as  $value) { if($key->main_menu_fk_id ==$value->main_header_id){?>
											...
											<div class="controls">
												<select tabindex="1" data-placeholder="Select Here....." class="span8" name="header_sub_menu_id" id="sub_menu" required>
													<option value="">Select Here.....</option>
													<?php foreach ($headre_sub_menu as  $value) { if($key->sub_menu_fk_id ==$value->sub_menu_id){?>
													
													<option value="<?php echo $value->sub_menu_id;?>" selected><?php echo $value->sub_menu_name;?></option>
													<?php } else { ?>
													<option value="<?php echo $value->sub_menu_id;?>"><?php echo $value->sub_menu_name;?></option>
													<?php }} ?>	
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" name="header_sub_child_name" placeholder="Header Sub Menu Name Here..." class="span8" pattern="[a-zA-Z\s]+" value="<?php echo $key->header_child_menu_name;?>" required>
