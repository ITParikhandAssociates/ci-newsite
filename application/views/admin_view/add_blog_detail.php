					...
					<div class="content">
						<div class="module">
							<div class="module-head">
								<h3>Add Blog Detail</h3>
							</div>
							<div class="module-body">
									<form class="form-horizontal row-fluid" method="POST" action="<?php echo base_url();?>blog/add_new_blog_detail" enctype="multipart/form-data">
									...
									<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" name="title" placeholder="Title Here..." class="span8" pattern="[a-zA-Z\s]+" maxlength="50" required>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="date"  name="now_date"  class="span8" required>
