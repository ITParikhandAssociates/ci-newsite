					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" method="POST" action="<?php echo base_url();?>about/update_choose_us" enctype="multipart/form-data">

										<?php foreach ($choose_us_data as $key) {?>
									<input type="hidden" name="choose_id" value="<?php echo $key->choose_id;?>">						
									<input type="hidden" name="old_img" value="<?php echo $key->choose_img;?>">
										...
										<div class="control-group">
											...
											<div class="controls">
												<img src="<?php echo base_url().'company_about_img/'.$key->choose_img;?>"  height="150" width="150"  alt="" >
